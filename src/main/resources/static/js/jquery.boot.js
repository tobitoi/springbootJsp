$(function() {
	...
	$("#pegawaiList").click(function() {
    	fetchList("pegawai");
    });
    $("#checkInOutList").click(function() {
        fetchList("checkInOut");
     });
    $("#departmentList").click(function() {
        fetchList("department");
     });
